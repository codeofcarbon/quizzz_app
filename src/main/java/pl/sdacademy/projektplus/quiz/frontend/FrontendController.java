...
public class FrontendController {
    ...
    @Autowired
    public FrontendController(OngoingGameService ongoingGameService,
    ...
    @GetMapping("/select")
    public String selectGameOptions(Model model) {
    ...
    @PostMapping("/select")
    public String initNewGame(@ModelAttribute GameOptions gameOptions) {
    ...
    @PostMapping("/game")
    public String checkIfThereIsNextQuestion(@ModelAttribute UserAnswer userAnswer) {
        ...
        if (hasNextQuestion) return "redirect:game";
        else return "redirect:summary";
    }
